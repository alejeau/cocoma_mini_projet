...
def yankee_swap(participants: [int], gifts: [int], utilities: {str: [int]}) -> {str: int}:
    """
    ...
    ----------
    participants: [int]
        the ordered list of participating agents: [1, 2, 0] means 1 goes first, 2 second and 0 third
    gifts: [int]
